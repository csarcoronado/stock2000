...
/* -------------------------------------------------------------------------------------------------------------------------- */
  ...
  const handleInputChange = (e: ChangeEvent<HTMLInputElement>, index: number) => {
    ...
    newValue = Math.max(0, Math.min(newValue, maxStock));
      ...
      <div className="bg-white p-3 ">
              ...
              {currentItems.map ((item,index) =>(
                <tr>
                  ...
                  <td style={{ textAlign: 'center' }}>
                    <button onClick={() => aumentarCantidad(index)} className='azul inline-flex items-center justify-center rounded-md ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 text-primary-foreground hover:bg-primary/90 h-1 px-0 py-0'><CiCirclePlus/></button>
                    ...
                    <button onClick={() => disminuirCantidad(index)} className='rojo inline-flex items-center justify-center rounded-md ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 text-primary-foreground hover:bg-primary/90 h-1 px-0 py-0'><CiCircleMinus/></button>
                  </td>
        ...
        <div  className="bg-gray-200 p-2 mb-2">
          <div>
            ...
            >
              {guardarTicket ? 'Cantidad' : 'Stock'}
            </button>
              <div className='izquierda'>
              <button className="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 bg-yellow-300">Siguiente</button>
              </div>
            </div>
          </div>
        </div>
